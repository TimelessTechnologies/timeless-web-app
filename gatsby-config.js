...
module.exports = {
  siteMetadata: {
    title: `Timeless Technologies`,
    description: `ONE STOP BESPOKE DIGITAL SOLUTIONS`,
    author: `@kloudcoder`,
    siteUrl: `https://timelesstechnologies.gatsbyjs.io/`,
  },
  plugins: [
    `gatsby-plugin-image`,
    {
    ...
    `gatsby-transformer-sharp`,
     {
      ...
      options: {
        typeName: "WPGraphQL",
        fieldName: "wpcontent",
        url: process.env.WPGRAPHQL_URL || `https://rulancreative.co.zw/graphql`,
      },
    },
    `gatsby-plugin-sharp`,
    {
